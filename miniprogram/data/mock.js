/* Mock 数据：场地 / 动态 / 排行榜 / 城市（图片走生成接口，开发工具中需关闭 URL 校验） */
...
function getVenue(id) {
  return VENUES.find(function (v) { return v.id === id })
}

/* 地图标记（场地A/B/C 对应前三个场地） */
const MAP_MARKERS = [
  { markerId: 1, venueId: 'binjiang', label: '场地A' },
  { markerId: 2, venueId: 'hongkou', label: '场地B' },
  { markerId: 3, venueId: 'xuhui', label: '场地C' },
]
...
module.exports = { VENUES: VENUES, getVenue: getVenue, MAP_MARKERS: MAP_MARKERS, FEED_LIST: FEED_LIST, LEADERBOARD: LEADERBOARD, CITIES: CITIES }
